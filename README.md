...
The network consists of seven campuses connected through seven campus routers.
...
The network uses IP addresses from multiple classes as required by the project specification.
...
- DNS Server
- Web Server
- End-user PCs and wireless devices
